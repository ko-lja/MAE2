...
public class PatternP2PTunnelPartCL extends P2PTunnelPart<PatternP2PTunnelPartCL>
  implements PatternP2PTunnelLogicCL.PatternP2PTunnel, PatternP2PPartLogicCL.PatternP2PPartLogicHostCL {
  ...
  private PatternProviderTargetCache targetCache; //TODO
  private final PatternP2PPartLogicCL partLogic = new PatternP2PPartLogicCL(this);

  public PatternP2PTunnelPartCL(IPartItem<?> partItem) {
    super(partItem);
    this.source = new MachineSource(this);
    if (this.isOutput()) {
      this.logic = null;
    } else {
      this.logic = LazyOptional.of(() -> new PatternP2PTunnelLogicCL(this));
    }
  }
  ...
  public void addToWorld() {
    super.addToWorld();
    this.targetCache = PatternP2PPartLogicCL.PatternP2PPartLogicHostCL.super.getCache();
  }
  ...
  @Override
  public @NotNull PatternProviderTargetCache getCache() { return this.targetCache; }
  ...
  public <T> LazyOptional<T> getCapability(Capability<T> capabilityClass) {
    if (this.isActive() && this.getFrequency() != 0) {
      ...
      if (this.isOutput()) {
        PatternP2PTunnelPartCL provider = this.getInput();
        if (provider == null)
  ...
  @Override
  public List<PatternP2PTunnelLogicCL.Target> getPatternTunnelInputs() {
    return List.of(this.getInput());
  }

  @Override
  public List<? extends PatternP2PTunnelLogicCL.Target> getPatternTunnelOutputs() {
