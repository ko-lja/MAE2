...
public class PatternP2PTunnelLogicCL implements ICraftingMachine {

  protected final PatternP2PTunnel tunnel;
  protected PatternProviderTargetCache[] caches; // TODO
  protected Set<AEKey> patternInputs;
  private int lastOutputIndex = 0;

  public static boolean isBlocking;

  public PatternP2PTunnelLogicCL(PatternP2PTunnel tunnel) {
    this.tunnel = tunnel;
    this.refreshInputs();
    this.refreshOutputs();
  }
  ...
  public void refreshInputs() {
    ...
    try {
      ...
      for (Target input : tunnel.getPatternTunnelInputs()) {
        ...
        if (provider == null) {
          ...
          if (maybeMachine != null
            && maybeMachine instanceof PatternP2PTunnelLogicCL inputLogic) {
      ...
      for (Target output : tunnel.getPatternTunnelOutputs()) {
        ...
        if (maybeMachine != null
          && maybeMachine instanceof PatternP2PTunnelLogicCL outputLogic) {
  ...
  public interface Target {
    ...
    @NotNull
    default PatternProviderTargetCache getCache() { // TODO
